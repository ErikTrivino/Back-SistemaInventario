...
export class UsuarioService {
  ...
  constructor(private http: HttpClient) {}
    ...
    editarUsuario(dto: EditarUsuario): Observable<MensajeDTO> {
      return this.http.post<MensajeDTO>(this.apiUrl + 'editarUsuario', dto, { headers: this.getAuthHeaders() });
    }
...
// Obtener todos los vehículos
  ...
  editarProveedor(dto: EditarProveedor): Observable<MensajeDTO> {
    return this.http.post<MensajeDTO>(this.apiUrl + 'editarProveedor', dto, { headers: this.getAuthHeaders() });
  }
  ...
  eliminarDetalleFactura(id: number): Observable<MensajeDTO> {
    return this.http.delete<MensajeDTO>(`${this.apiUrl}eliminarDetalleFactura/${id}`, { headers: this.getAuthHeaders() });
  }

  // Editar un detalle de factura
  editarDetalleFactura(dto: EditarDetalleFactura): Observable<MensajeDTO> {
    return this.http.post<MensajeDTO>(this.apiUrl + 'editarDetalleFactura', dto, { headers: this.getAuthHeaders() });
  }
  ...
  editarDetallePedido(dto: EditarDetallePedido): Observable<MensajeDTO> {
    return this.http.post<MensajeDTO>(this.apiUrl + 'editarDetallePedido', dto, { headers: this.getAuthHeaders() });
  }
  // Obtener todos los detalles
  ...
  editarDetalleServicioProducto(dto: EditarDetalleServicioProducto): Observable<MensajeDTO> {
    return this.http.post<MensajeDTO>(this.apiUrl + 'editarDetalleServicioProducto', dto, { headers: this.getAuthHeaders() });
  }
}
