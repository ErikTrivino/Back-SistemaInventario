...
public interface ReporteServicio {
    ...
    ReporteVentasDTO generarReporteVentas(Date inicio, Date fin);

    /** RF-29/RF-30: Reporte de inventario de una sucursal en un momento. */
    ReporteInventarioDTO generarReporteInventario(Long idSucursal);

    /** RF-29/RF-30: Reporte de transferencias por período. */
    ReporteTransferenciasDTO generarReporteTransferencias(Date inicio, Date fin);
    ...
    ReporteRotacionDTO generarAnalisisRotacion(int mes, int anio);
}
