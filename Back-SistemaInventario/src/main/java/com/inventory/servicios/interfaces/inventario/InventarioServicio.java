...
public interface InventarioServicio {
    ...
    Page<com.inventory.modelo.dto.inventario.InventarioRespuestaDTO> getInventoryByBranch(Long branchId, Boolean activo,
    ...
    Page<com.inventory.modelo.dto.inventario.InventarioRespuestaDTO> getCatalogoActivo(Long branchId, Boolean activo,
            Integer pagina, Integer porPagina);
}
