...
public class TransferenciaServicioImpl implements TransferenciaServicio {
        ...
        public TransferenciaInformacionDTO prepareTransfer(TransferenciaPrepararDTO dto) {
                ...
                // RF-18: Actualizar cantidades confirmadas
                transfer.getDetalles().forEach(detalle -> {
                        detalle.setCantidadConfirmada(dto.cantidadConfirmada());
                });

                // Crear/Actualizar la Ruta según los datos proporcionados
                Ruta ruta = Ruta.builder()
                                .sucursalOrigenId(transfer.getSucursalOrigenId())
                                .sucursalDestinoId(transfer.getSucursalDestinoId())
                                .tipoClasificacion(dto.tipoClasificacion())
                                .leadTimeEstandar(dto.leadTimeEstandar())
                                .build();

                Ruta savedRuta = rutaRepositorio.save(ruta);
        ...
        public TransferenciaInformacionDTO shipTransfer(TransferenciaConfirmarEnvioDTO dto) {
                ...
                Envio envio = Envio.builder()
                                ...
                                .rutaId(transfer.getRuta().getId())
                        .transportistaId(dto.idTransportista())
                                .build();
    ...
    public TransferenciaInformacionDTO cancelarTranferencia(TrasnferenciaCancelarDTO dto) {
        ...
        @Override
        public Page<TransferenciaInformacionDTO> getTransfersByDestino(Long sucursalDestinoId, String status,
                ...
                return transferRepository
                                .findTransfersBySucursalDestino(sucursalDestinoId, status, startDate, endDate, pageable)
                                .map(this::toInfo);
        }
