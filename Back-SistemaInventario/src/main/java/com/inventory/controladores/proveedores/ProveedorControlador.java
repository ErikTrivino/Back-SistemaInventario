...
public class ProveedorControlador {
    ...
    public ResponseEntity<MensajeDTO<Object>> actualizar(@PathVariable Long id,
            @Valid @RequestBody ProveedorEditarDTO dto) {
    ...
    public ResponseEntity<MensajeDTO<Object>> preciosPorProveedor(
        ...
        return ResponseEntity
                .ok(new MensajeDTO<>(false, proveedorServicio.getListaPreciosPorProveedor(id, pagina, porPagina)));
    }
    ...
    public ResponseEntity<MensajeDTO<Object>> preciosPorProducto(
        ...
        return ResponseEntity.ok(
                new MensajeDTO<>(false, proveedorServicio.getListaPreciosPorProducto(idProducto, pagina, porPagina)));
    }
